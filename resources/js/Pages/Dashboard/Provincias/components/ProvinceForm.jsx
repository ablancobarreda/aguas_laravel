...
export default function ProvinceForm({
  ...
  const validateForm = () => {
    ...
    if (!formData.name.trim()) {
      newErrors.name = 'El nombre de la provincia es requerido';
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900">
                {initialData ? 'Editar Provincia' : 'Nueva Provincia'}
              </h3>
              <p className="text-sm text-gray-500">
                {initialData ? 'Modifica los datos de la provincia' : 'Completa la información requerida'}
              </p>
            </div>
          </div>
          <button
        ...
        <div className="px-6 py-4 space-y-6">
          <div>
            <label htmlFor="name" className="block text-sm font-medium text-gray-700 mb-2">
              Nombre de la Provincia <span className="text-red-500">*</span>
            </label>
            <input
              type="text"
              id="name"
              ...
              placeholder="Ej: La Habana, Santiago de Cuba"
              disabled={loading}
              required
              autoFocus
            />
