    ...
    return (
      <div className="bg-white rounded-xl shadow-sm border border-gray-200">
        <div className="p-8 text-center">
          ...
          <p className="mt-2 text-gray-600">Cargando provincias...</p>
        </div>
      </div>
    );
  }
        ...
        {provinces.length === 0 ? (
          <div className="p-8 text-center">
            <div className="flex flex-col items-center">
              ...
              <h3 className="mt-2 text-sm font-medium text-gray-900">No hay provincias</h3>
              <p className="mt-1 text-sm text-gray-500">Comienza creando una nueva provincia.</p>
            </div>
          </div>
        ) : (
          provinces.map((province) => (
            <div key={province.id} className="p-4 hover:bg-gray-50 transition-colors">
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center space-x-2 mb-2">
                    <span className="text-xs font-medium text-gray-500">ID:</span>
                    <span className="text-sm font-medium text-gray-900">{province.id}</span>
                  </div>
                  <div className="mb-2">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-xs text-gray-900">{formatDate(province.created_at)}</span>
                  </div>
                </div>
            ...
            {provinces.length === 0 ? (
              ...
              provinces.map((province) => (
                <tr key={province.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                    {formatDate(province.created_at)}
                  </td>
